...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pb-4 pt-0 leading-7 text-muted-foreground [&_a]:underline [&_a]:underline-offset-4",
          className
        )}
      >
        {children}
