    ...
    <div className="mt-6">
      ...
      {fetching ? (
        ...
        <div className="mt-4 space-y-3">
          {comments.map((c) => (
            <div key={c.id} className="border p-3 rounded dark:border-gray-600">
              ...
              <p className="text-sm text-gray-800 dark:text-white">{c.content}</p>
