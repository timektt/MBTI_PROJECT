...
export const mbtiZHomeCopy = {
  th: {
    pageTitle: "MBTI Z | ห้องทดลองบุคลิกแฟนตาซี",
    metaDescription:
      "MBTI Z คือห้องทดลองบุคลิกแฟนตาซีแบบ TH-first ที่รวม 4 houses, สัตว์ประจำ type, Movie Profile และ Result Artifact ที่แชร์ได้",
    eyebrow: "MBTI Z",
    status: "เริ่มแบบ guest · TH เป็นค่าเริ่มต้น · 16 types",
    title:
      "อ่านตัวตนผ่าน 4 Houses, สัตว์ประจำ Type และ Movie Profile ใน Result Artifact เดียว",
    subtitle:
      "MBTI Z อ่านพลังงาน วิธีรับข้อมูล การตัดสินใจ และรสนิยมการดูหนังของคุณในลำดับเดียว แล้วสรุปออกมาเป็น Artifact ที่พร้อมเก็บต่อหรือแชร์ต่อได้ทันที",
    ...
    houseTitle: "4 houses ที่ขับบุคลิกทั้งระบบ",
    houseSubtitle:
    ...
    finalTitle: "เริ่มจาก flow ที่ใช้งานได้จริง แล้วค่อยต่อยอด asset และ cloud ทีละชั้น",
    finalBody:
      "ตอนนี้แกนใหม่ของ MBTI Z คือการเริ่มแบบ guest, แยกตาม House และอ่าน Movie Profile ร่วมกัน จากนั้นค่อยต่อยอด asset fantasy และ cloud layer ให้แน่นขึ้นทีละชั้น",
    finalCta: "เข้าแบบทดสอบตอนนี้",
  },
  en: {
    pageTitle: "MBTI Z | Fantasy Personality Lab",
    metaDescription:
      "MBTI Z is a Thai-first fantasy personality lab with 4 houses, type animals, a Movie Profile module, and a share-ready Result Artifact.",
    eyebrow: "MBTI Z",
    status: "guest-first runtime · TH default · 16 types",
    title:
      "Read yourself through 4 Houses, fantasy animals, and a Movie Profile in one Result Artifact.",
    subtitle:
      "MBTI Z reads energy, perception, decision style, and movie taste in one flow, then turns it into an Artifact that is ready to keep or share.",
    ...
    houseTitle: "The 4 houses behind the full system",
    houseSubtitle:
    ...
    finalTitle: "Start with the working flow, then deepen the assets and cloud layers",
    finalBody:
      "The current MBTI Z core is a guest-first, house-based, movie-aware flow. The next steps are sharper surfaces, stronger fantasy assets, and a cleaner export path for real sharing.",
